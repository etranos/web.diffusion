...
new technology that is the web. This is key point in the lifecycle of a
...
illustrates this [@tranos2020social]. During this period the performance
...
web in the UK as it contains all the commercial websites archived by the
Internet Archive [^2] that include a mention to at least one valid UK
postcode in the web text. Websites are identified as commercial ones if
they are part of the .co.uk second level domain (SLD). Also, the act of
of creating a website is understood here as active engagement with the
...
invented and commercially deployed [@grubler1990rise; @grubler1990rise].
...
**ADD DATA
DESCRIPTION, WHY .CO.UK, FAMILY OF WEB TECHNOLOGIES**
...
population centres is surpassed by proximity to them and soatial configuration 
at this scale.
