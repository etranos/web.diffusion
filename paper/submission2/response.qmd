...
H1: first descriptives, then modelling
- S curves
Figure 1: UK curve, Figure 2: some LAD curves. link to a gif. 
keep fast slow map, briefly touch upon and say it will be further discussed below
- neighbourhood
- hierarchy
- modelling

H2: link map with ranks. Explore OA stability within LADs
...
**reveal that theories are valid for local scales and inform local tech policies**
