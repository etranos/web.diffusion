...
for(i in 1:10) seeds[[i]]<- sample.int(n=1000, 8)
...
for (t in years){
  tplus1 <- t + 1
  set.seed(71)
  model.all <- train(n ~ area + dist + dist.retail + London + 
                     n.lag + n.slag + n.l.slag + n.nearest.city + year,
