...
for (i in regions){
  ...
  #file <- paste0(path, "/outputs/rf/models/oa_rf/regions/region_corrected_", as.character(i), ".RData")
...
# correct for non-England file names
df <- df %>% 
  mutate(RGN11CD = ifelse(RGN11CD == "Wales", "W0",
                          ifelse(RGN11CD == "Scotland", "S1",
                                 ifelse(RGN11CD == "NI", "N0", RGN11CD)))) 
