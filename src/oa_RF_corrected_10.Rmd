...
df.corrected <- bind_rows(df9610, df1112) %>% 
  ...
  mutate(n = ifelse(pc %in% as.character(problem.pcs) & year > 2003 & year <2007, NA, n))
...
#   2     variance    1.221299  0.4082199  0.5829598
#   2     extratrees  1.308769  0.3297824  0.6136490
#   5     variance    1.203082  0.4241359  0.5703508
#   5     extratrees  1.280883  0.3513153  0.6124031
#   8     variance    1.214268  0.4155308  0.5674246
#   8     extratrees  1.284107  0.3502621  0.6180390
# 
...
THE BELLOW HAS NOT BEEN RUN NEITHER THE FILENAMES HAS BEEN CHANGED (add: _corrected)
