...
df <- df %>% filter(year > 1996) %>% 
  dplyr::select(oa11cd, year, RGN11CD, n, abs.growth, n.l.slag, n.nearest.city.lag, n.nearest.retail.lag, n.London.lag, London, dist, dist.retail) #growth, abs.growth, RGN11NM, 
