...
-   4 sets of models:
    ...
    -   Train on one region, test on the rest ⟹ *spatial differences and
        similarities* of diffusion mechanisms
...
path.image <- paste0(path, "/outputs/rf/varimp_LA.png")
knitr::include_graphics(path.image)
```
...
path.image <- paste0(path, "/outputs/rf/varimp_OA.png")
knitr::include_graphics(path.image)
```
...
#, out.height= "60%", out.width="60%"
path.image <- paste0(path, "/outputs/rf/heatmap_LA.png")
knitr::include_graphics(path.image)
```

## Regional similarities for Output Areas

```{r similarity_OA, eval = T, out.height= "70%", out.width="70%", message=FALSE}

path.image <- paste0(path, "/outputs/rf/heatmap_OA.png")
knitr::include_graphics(path.image)
```
